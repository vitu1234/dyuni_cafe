<?php
  ...
  //get users
    ...
    $getMenus = $operation->retrieveMany("SELECT *FROM menu_items INNER JOIN meals ON menu_items.meal_id = meals.meal_id ORDER BY menu_id DESC");
?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="meals.php">Meals</a></li>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
           ...
           <a  class="btn btn-warning float-right text-light" href="#add-admin" data-toggle="modal"  role="button" id="addAdmin" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="la la-plus text-3 mr-1"></i>Schedule Menu</a>
                  </div>
                  <div class="card-body">
