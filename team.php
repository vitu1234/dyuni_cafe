<?php
  ...
  //get users
    ...
    $getStaff = $operation->retrieveMany("SELECT *FROM staff ORDER BY staff_name ASC");
...
<div class="wrapper">
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="card-title"></div>
										...
										<a  class="btn btn-warning pull-right" href="#add-admin" data-toggle="modal"  role="button" id="addAdmin" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="la la-plus text-3 mr-1"></i>Add Member</a>
                  </div>
                  <div class="card-body">
                    <table class="table table-hover" id="user_tbl">
											...
											<tbody>
                                              ...
                                              <?php
                                                foreach($getStaff as $row){
                                                  ...
                                                  $btn_sus = '';
                                                    ...
                                                    $btn_del = '<div class="col-12 col-sm-6">
                                                                  <button data-dismiss="modal" onclick="getDeleteUser(\''.$row['staff_id'].'\')"  id="btn_e_del'.$row['staff_id'].'" class="btn btn-danger btn-block mt-2" type="button">Delete Member</button>
                                                          </div>';
                                                  ...
                                                  if($row['img_url'] != ''){
                                                      $img = '<img height=80px" src="../images/staff/'.$row['img_url'].'"/>';
                                                  }else{
                                                  ...
                                                  echo '
                                                    <tr>
                                                      ...
                                                      <td>'.$row['staff_email'].'- '.$row['staff_phone'].'</td>
                                                      <td>
                                                          <div class="form-button-action">
                                                              <a href="#view-user'.$row['staff_id'].'" data-toggle="modal"  role="button" id="addAdmin" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" type="button" data-toggle="tooltip" title="View" class="btn btn-link btn-simple-primary">
                                                                  <i class="fas fa-eye"></i>
                                                              </a>
                                                          </div>
                                                          
                                                          <div class="form-button-action">
																	<a onclick="setUpdateMeal(\''.$row['staff_id'].'\')" href="#view-meal'.$row['staff_id'].'" data-toggle="modal"  role="button" id="addAdmin" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" type="button" data-toggle="tooltip" title="Change Picture" class="btn btn-link btn-simple-primary">
                                               ...
                                               <div id="view-user'.$row['staff_id'].'" class="modal fade " role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                  <div class="modal-content">
                                                    ...
                                                    <div id="adminResponse" style="width:100%;"></div>
                                                      ...
                                                      <form id="editStaffForm'.$row['staff_id'].'" method="post">
                                                        <div class="row">
                                                          <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                              <label for="firstName">Fullname</label>
                                                              <input type="text" class="form-control" data-bv-field="firstName" id="efullname'.$row['staff_id'].'" name="efullname" required placeholder="Fullname" value="'.$row['staff_name'].'" />
                                                            </div>
														  ...
														  <div class="form-group">
															...
															<input type="text" class="form-control" data-bv-field="firstName" id="eposition" name="eposition" required placeholder="Position" value="'.$row['position'].'" />
														  </div>
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            ...
                                                            <div class="form-group">
                                                              ...
                                                              <input type="tel" class="form-control" data-bv-field="firstName"  onkeypress="return isNumberKey(event)" id="ephone'.$row['staff_id'].'" name="ephone" required placeholder="Phone" value="'.$row['staff_phone'].'" />
                                                            </div>
                                                          ...
                                                          <div class="col-12 col-sm-6">
                                                            ...
                                                            <div class="form-group">
                                                              ...
                                                              <input type="email" class="form-control" data-bv-field="firstName" id="eemail'.$row['staff_id'].'" name="eemail" required placeholder="Email" value="'.$row['staff_email'].'" />
                                                            </div>
                                                         ...
                                                         <div class="col-12 ">
                                                             <label for="firstName">Bio</label>
                                                              <textarea class="form-control" data-bv-field="firstName" id="ebio'.$row['staff_id'].'" name="ebio" required placeholder="Bio" >'.$row['staff_bio'].'</textarea>
                                                         </div>
                                                         
                                                         <input type="hidden" id="e_staff_id'.$row['staff_id'].'" name="e_staff_id" value="'.$row['staff_id'].'"/>
                                                         
                                                  
                                                         <div class="row">
                                                          <div class="col-12 col-sm-6">
                                                                  <button onclick="editStaff(\''.$row['staff_id'].'\')"  id="editUserBtn'.$row['staff_id'].'" class="btn btn-warning btn-block mt-2" type="submit">Update Member</button>
                                                          </div>
                                                ...
                                                <div id="view-meal'.$row['staff_id'].'" class="modal fade " role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                  <div class="modal-content">
                                                    <div class="modal-header">
                                                 ...
                                                 <div  id="pictureForm'.$row['staff_id'].'">
                                                 
                                                      <form id="editPictureForm'.$row['staff_id'].'" method="post">
                                                       <div class="col-12 ">

                                                            <div class="form-group">
                                                                    <label for="firstName">Picture</label>
                                                                    <input type="file" class="form-control" data-bv-field="firstName" id="meal_pic'.$row['staff_id'].'" accept="image/*" name="meal_pic" required placeholder="Picture" />
                                                                  </div>
                                                              </div>
                                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" id="uploadimageContainer'.$row['staff_id'].'" style="display: none;">
                                                                <div class="row">
                                                                    <div class="col-md-12 text-center">
                                                                      <div id="image_demo'.$row['staff_id'].'" style="width:100%; margin-top:30px"></div>
                                                                    </div>
                                                      ...
                                                      <div class="row">  
                                                        <div class="col-12 col-sm-6">
                                                                ...
                                                                <div class="form-group">
                                                                     <button style="display: none;"  id="btn_add'.$row['staff_id'].'" class="btn btn-warning  crop_image btn-block mt-2" type="button">Change picture</button>
                                                                </div>
                                                            </div>
                                                           <div class="col-12 col-sm-6">
  ...
  <div id="add-admin" class="modal fade " role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title font-weight-400">NEW MEMBER</h5>
            <button type="button" class="close font-weight-400" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
          </div>
          <div class="modal-body p-4">
              <div id="adminResponse" style="width:100%;"></div>
            ...
            <form id="addStaffForm" method="post">
              <div class="row">
				...
				<div class="col-12 col-sm-6">
                  <div class="form-group">
                    <label for="firstName">Position</label>
                    <input type="text" class="form-control" data-bv-field="firstName" id="position" name="position" required placeholder="Position" />
                  </div>
            ...
            <div class="col-12 col-sm-6">
                  ...
                  <div class="form-group">
                    <label for="firstName">Phone</label>
                    <input type="text" class="form-control" onkeypress="return isNumberKey(event)" data-bv-field="firstName" id="phone" name="phone" required placeholder="Phone" />
                  </div>
              </div>
            ...
            <div class="col-12 ">
                  ...
                  <div class="form-group">
                    <label for="firstName">Bio</label>
                    <textarea id="bio" name="bio" required placeholder="Bio" class="form-control" data-bv-field="firstName" rows="2"></textarea>
                  </div>
              </div> 
			...
			<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" id="uploadimageContainer" style="display: none;">
              ...
              <button style="display:none;"  id="btn_add" class="btn btn-warning crop_image btn-block px-5 mt-2" type="button">Add Member</button>
            </form>
          </div>
        </div>
      </div>
  ...
  <div id="deleteUserModal" class="modal fade " role="dialog" aria-hidden="true">
      <div class="modal-dialog " role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title font-weight-400" id="title">DELETE STAFF MEMBER</h5>
            <button type="button" class="close font-weight-400" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
          </div>
          <div class="modal-body p-4">
            ...
            <form id="deleteStaffForm" method="post">
              ...
              <p id="msg">Are you sure you want to delete this staff member?</p>
                <div class="row">
	...
	$('#btn_add').click(function(event){
		...
		image_crop.croppie('result', {
		  ...
		  quality: 1
			...
			if(email !== "" && fullname !=="" && bio !== "" && position !== ''){
				$("#btn_add").html('<span class="spinner-border spinner-border-sm text-light" role="status" aria-hidden="true"></span> Adding...');
				$.ajax({
					url:"process/staff.php",
					type: "POST",
					data:{"img": response,"fullname":fullname,"phone":phone,"email":email, "bio":bio,"position":position},
