...
<div class="wrapper">
            ...
            <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <a  class="btn btn-warning pull-right" href="#add-admin" data-toggle="modal"  role="button" id="addAdmin" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="la la-plus text-3 mr-1"></i>Add Article</a>
                      ...
                      <tbody>
                                              ...
                                              <?php
                                                foreach($getNews as $row){
                                                  ...
                                                  $btn_sus = '';
                                                    ...
                                                    $btn_del = '<div class="col-12 col-sm-6">
                                                                  <button data-dismiss="modal" onclick="getDeleteNews(\''.$row['news_id'].'\')"  id="btn_e_del'.$row['news_id'].'" class="btn btn-danger btn-block mt-2" type="button">Delete </button>
                                                          </div>';
                                                ...
                                                if($row['attachment_url'] != ''){
                                                      $attach = '<a class="pull-right"  href="../images/news/'.$row['attachment_url'].'">View Attachment</a>';
                                                  }
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                          <div class="form-button-action">
                                                              <a href="#view-user'.$row['news_id'].'" data-toggle="modal"  role="button" id="addAdmin" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" type="button" data-toggle="tooltip" title="View" class="btn btn-link btn-simple-primary">
                                                                  <i class="fas fa-eye"></i>
                                                              </a>
                                                          </div>
                                                          
                                                           <div class="form-button-action">
                                  <a onclick="setUpdateMeal(\''.$row['news_id'].'\')" href="#view-meal'.$row['news_id'].'" data-toggle="modal"  role="button" id="addAdmin" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" type="button" data-toggle="tooltip" title="Change Picture" class="btn btn-link btn-simple-primary">
                                                                  <i class="fas fa-photo"></i>
                                                              </a>
                                </div>
                                                            <div class="form-button-action">
                                  <a onclick="setUpdateAttachment(\''.$row['news_id'].'\')" href="#view-attachment" data-toggle="modal"  role="button" id="addAdmin" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" type="button" data-toggle="tooltip" title="Add/Change Attachment" class="btn btn-link btn-simple-primary">
                                               ...
                                               <div id="view-user'.$row['news_id'].'" class="modal fade " role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                  <div class="modal-content">
                                                    ...
                                                    <div id="adminResponse" style="width:100%;"></div>
                                                      ...
                                                      <form id="editNewsForm'.$row['news_id'].'" method="post">
                                                        <div class="row">
                                                          <div class="col-12 ">
                                                            <div class="form-group">
                                                              <label for="firstName">Title</label>
                                                              <input type="text" class="form-control" data-bv-field="firstName" id="etitle'.$row['news_id'].'" name="etitle" required placeholder="Title" value="'.$row['title'].'" />
                                                            </div>
                                                         ...
                                                         <div class="col-12 ">
                                                             <label for="firstName">Body</label>
                                                              <textarea class="form-control" data-bv-field="firstName" id="content'.$row['news_id'].'" name="econtent" required placeholder="Body" >'.$row['content'].'</textarea>
                                                         </div>
                                                         
                                                         <input type="hidden" id="e_news_id'.$row['news_id'].'" name="e_news_id" value="'.$row['news_id'].'"/>
                                                         
                                                  
                                                         
                                                          <div class="col-12 col-sm-6">
                                                                  <button onclick="editNews(\''.$row['news_id'].'\')"  id="editUserBtn'.$row['news_id'].'" class="btn btn-warning btn-block mt-2 " type="submit">Update </button>
                                                          </div>
                                                ...
                                                <div id="view-meal'.$row['news_id'].'" class="modal fade " role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                  <div class="modal-content">
                                                    <div class="modal-header">
                                                 ...
                                                 <div  id="pictureForm'.$row['news_id'].'">
                                                 
                                                      <form id="editPictureForm'.$row['news_id'].'" method="post">
                                                       <div class="col-12 ">

                                                            <div class="form-group">
                                                                    <label for="firstName">Picture</label>
                                                                    <input type="file" class="form-control" data-bv-field="firstName" id="meal_pic'.$row['news_id'].'" accept="image/*" name="meal_pic" required placeholder="Picture" />
                                                                  </div>
                                                              </div>
                                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" id="uploadimageContainer'.$row['news_id'].'" style="display: none;">
                                                                <div class="row">
                                                                    <div class="col-md-12 text-center">
                                                                      <div id="image_demo'.$row['news_id'].'" style="width:100%; margin-top:30px"></div>
                                                                    </div>
                                                      ...
                                                      <div class="row">  
                                                        <div class="col-12 col-sm-6">
                                                                ...
                                                                <div class="form-group">
                                                                     <button style="display: none;"  id="btn_add'.$row['news_id'].'" class="btn btn-warning  crop_image btn-block mt-2" type="button">Change picture</button>
                                                                </div>
                                                            </div>
                                                           <div class="col-12 col-sm-6">
  ...
  <div id="add-admin" class="modal fade " role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title font-weight-400">NEW NEWS ARTICLE</h5>
            <button type="button" class="close font-weight-400" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
          </div>
          <div class="modal-body p-4">
    ...
    image_crop.croppie('result', {
      ...
      if(titlex !== "" && contentx !==""){
        ...
        $.ajax({
          url:"process/news.php",
          type: "POST",
          data:{"img": response,"title":titlex,"content":contentx},
